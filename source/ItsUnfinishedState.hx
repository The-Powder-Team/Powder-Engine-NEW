...
class ItsUnfinishedState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"This engine is unfinished."
			+ "\nYou may experience bugs, crashes and glitches."
			+ "\n\nReport all bugs to the Discord Server's forum's bug report category."
			+ "\nPress Space to do so or Escape to ignore it.",
			32);
	...
	override function update(elapsed:Float)
	{
		...
		{
			fancyOpenURL("https://discord.gg/T2mvCJmsJf");
		}
