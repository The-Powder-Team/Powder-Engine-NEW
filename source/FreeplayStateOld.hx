...
{
	public static var modCatagories:Array<ModCatagory> = [];

	public static var currentSelectedMod:ModCatagory;
	...
	private static var iconArray:Array<HealthIcon> = [];

	public static var openedPreview = false;

	public static var isInModCat:Bool = false;
	...
	static function changeDiff(change:Int = 0)
	{
	...
	function changeSelection(change:Int = 0)
	{
		...
		diffCalcText.text = 'RATING: ${DiffCalc.CalculateDiff(songData.get(songs[curSelected].songName)[curDifficulty])}';
		diffText.text = 'DIFF:' + CoolUtil.difficultyFromInt(curDifficulty).toUpperCase();
